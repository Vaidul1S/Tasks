            ...
            {storyUpload !== null ? <div className="screen-message"><h2>{storyUpload}</h2></div> :
                <section className="create">
                    <div className="create_content">
                        ...
                        <p>Partner with us to create your new campaign and manage donations seamlessly. We're excited to support your fundraising journey and welcome you to the our community. Thank you for letting share your love with other.</p>
